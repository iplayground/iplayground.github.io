        ...
        <div>
          <div id="nav">
            ...
            <div className="nav-link-container" id="nav-link-container">
              ...
              {/* <div className="nav-link"><a href="#sechdule-section"><p>Schedule</p><p>議程</p></a></div> */}
              ...
              {/* <div className="nav-link"><a href="#sponsors-section"><p>{<Trans>navTitle.sponsorships</Trans>}</p><p>{<Trans>navTitle.sponsorships2</Trans>}</p></a></div> */}
              ...
              <div className="nav-link nav-button"><ActionButton style={{ fontSize: "30px", lineHeight: "40px" }} title={<Trans>navButtonTitle.buyTicket</Trans>} link="https://iplayground.kktix.cc/events/iplayground2020" /></div>
